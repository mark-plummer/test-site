...
last_updated: tbd sidebar: mydoc_sidebar permalink: /:collection/:path.html -- Some tables may take an unusually long time to load due to a high data version issue.
