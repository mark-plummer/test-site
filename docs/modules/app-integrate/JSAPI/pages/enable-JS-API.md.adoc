...
last_updated: tbd sidebar: mydoc_sidebar permalink: /:collection/:path.html -- If your ThoughtSpot system is configured for Security Assertion Markup Language (SAML) you can enable Single Sign On (SSO) for your embed application.
