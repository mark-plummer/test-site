...
+
image::{{ site.baseurl }}/images/create_custom_action.png[]
...
+
image::{{ site.baseurl }}/images/initiate_custom_action.png[]

. When a user clicks your action, they'll see the web page you entered as the URL for your custom action.
+
image::{{ site.baseurl }}/images/custom_action_response.png[]
