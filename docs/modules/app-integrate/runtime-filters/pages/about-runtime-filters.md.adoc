...
last_updated: tbd sidebar: mydoc_sidebar permalink: /:collection/:path.html -- Runtime filters allow you to filter an answer or pinboard through parameters you pass in the URL to filter the data that is returned.
