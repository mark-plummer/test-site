...
last_updated: tbd sidebar: mydoc_sidebar permalink: /:collection/:path.html -- For recurring data loads and for scripting loads, use `tsload` (the ThoughtSpot Loader).
