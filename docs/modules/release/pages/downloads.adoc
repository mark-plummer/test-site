...
* *Linux*:  https://thoughtspot.egnyte.com/dl/84csZ4USEX/ThoughtSpot_odbc_linux_3.8.tar.gz_[ThoughtSpot_odbc_linux_3.4.tar.gz] + See link:{{ site.baseurl }}/data-integrate/clients/install-odbc-linux.html[Install the ODBC driver on Linux]
