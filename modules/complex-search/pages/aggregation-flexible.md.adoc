...
For more extensive examples of using the `group-aggregate` function, we encourage you to see link:{{site.baseurl}}/reference/reaggregation-scenarios.html[Reaggreggation scenarios in practice]
